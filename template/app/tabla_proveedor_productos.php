...
?>
   ...
   <div class="header">
        ...
        <a href="" class="btn btn-info btn-with-icon pull-right" href="" data-toggle="modal" data-target="#modal_proveedor_producto" onclick="limpiar_producto()">
...
<div id="modal_proveedor_producto" class="modal fade">
  
  <div class="modal-dialog modal-dialog-vertical-center modal-lg" role="document" style="max-width: 850px;">
    <div class="modal-content bd-0 tx-14">
      <form id="guardar_proveedor_producto" method="post" enctype="multipart/form-data"> 
      ...
      <div class="modal-body pd-25" id="div_modal_proveedor_producto">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control valid" type="email" name="email_comercial_vende" id="email_comercial_vende" value="" placeholder="" required="">
                    </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control valid" type="text" name="prefijo_pais" id="prefijo_pais" placeholder="">
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input class="form-control valid" type="text" name="telefono" id="telefono"  placeholder="">
                    </div>
                </div>
              ...
              <div class="row">
                 ...
                 <div class="col-md-6">
                    <div class="form-group">
                       ...
                       <select data-title="SELECCIONA" name="id_comercial_compra" id="id_comercial_compra"  value=""data-live-search="true"  class="selectpicker form-control" required="">
                         <?php
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control valid" ttype="number" step="0.01" name="comision" id="comision"  placeholder="" required="">
                    </div>
                </div>
...
<div id="procesa_proveedor_producto"></div>
...
$(document).ready (function() {
  $.ajax({
      url: "../backend/get_proveedor_producto.php?id_proveedor=<?=$id_proveedor?>",
      beforeSend: function(){
            //imagen de carga
          ...
          table.on( 'click', '.delete', function (e) {
            ...
            if (confirma == true){
                ...
                var list_id = data[0];
                 ...
                 $('#procesa_proveedor_producto').load('../backend/guardar_proveedor_producto.php?id_borrar='+list_id);
           ...
           table.on( 'click', '.modify', function (e) {
              ...
              document.getElementById("div_modal_proveedor_producto").innerHTML = "";
              
              $('#div_modal_proveedor_producto').load('edita_proveedor_producto.php?id='+list_id);
              $('#modal_proveedor_producto').modal('show');
              e.preventDefault();
          });
      }       
  });
...
$('#guardar_proveedor_producto').submit(function () {

    $('#modal_proveedor_producto').modal('hide');

        $('#procesa_proveedor_producto').delay(800).queue(function(nxt){

            $.post('../backend/guardar_proveedor_producto.php', $('#guardar_proveedor_producto').serialize(), function (data, textStatus) {
        
                $('#procesa_proveedor_producto').append(data);
            });
