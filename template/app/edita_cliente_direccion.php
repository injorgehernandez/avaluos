...
$stmt = $conn->prepare("SELECT id_cliente, calle, numero_interior, numero_exterior, cp, municipio, estado, pais FROM cliente_direccion where id=?");

$stmt->bind_param("i", $id);
$stmt->execute();
$stmt->bind_result($id_cliente_bdd, $calle_bdd, $numero_interior_bdd, $numero_exterior_bdd, $cp_bdd, $municipio_bdd, $estado_bdd, $pais_bdd);
