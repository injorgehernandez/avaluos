...
?>
   ...
   <div class="header">
        ...
        <a href="" class="btn btn-info btn-with-icon pull-right" href="" data-toggle="modal" data-target="#modal_proveedor_direccion" onclick="limpiar_direccion()">
    ...
    <div class="table-wrapper">
        <table id="datatabledireccions" class="table display responsive nowrap" style="width:100%">
          <thead>
            <tr>
...
<div id="modal_proveedor_direccion" class="modal fade">
  
  <div class="modal-dialog modal-dialog-vertical-center modal-lg" role="document" style="max-width: 850px;">
    <div class="modal-content bd-0 tx-14">
      <form id="guardar_proveedor_direccion" method="post" enctype="multipart/form-data"> 
      ...
      <div class="modal-body pd-25" id="div_modal_proveedor_direccion">
...
<div id="procesa_proveedor_direccion"></div>
...
$(document).ready (function() {
  $.ajax({
      url: "../backend/get_proveedor_direccion.php?id_proveedor=<?=$id_proveedor?>",
      beforeSend: function(){
            //imagen de carga
      ...
      success : function(data) {
          ...
          var table = $('#datatabledireccions').DataTable();
          // Borrar Lista
          table.on( 'click', '.delete', function (e) {
            ...
            if (confirma == true){
                ...
                var list_id = data[0];
                 ...
                 $('#procesa_proveedor_direccion').load('../backend/guardar_proveedor_direccion.php?id_borrar='+list_id);
           ...
           table.on( 'click', '.modify', function (e) {
              ...
              document.getElementById("div_modal_proveedor_direccion").innerHTML = "";
              
              $('#div_modal_proveedor_direccion').load('edita_proveedor_direccion.php?id='+list_id);
              $('#modal_proveedor_direccion').modal('show');
              e.preventDefault();
          });
      }       
  });
...
$('#guardar_proveedor_direccion').submit(function () {

    $('#modal_proveedor_direccion').modal('hide');

        $('#procesa_proveedor_direccion').delay(800).queue(function(nxt){

            $.post('../backend/guardar_proveedor_direccion.php', $('#guardar_proveedor_direccion').serialize(), function (data, textStatus) {
        
                $('#procesa_proveedor_direccion').append(data);
            });
