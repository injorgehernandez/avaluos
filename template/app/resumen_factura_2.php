...
<div class="br-pageheader pd-y-15 pd-l-20">
  <nav class="breadcrumb pd-0 mg-0 tx-12">
    ...
    <span class="breadcrumb-item active">Pedidos pendientes de registro de factura de compra</span>
  </nav>
</div><!-- br-pageheader -->
<div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
  <h4 class="tx-gray-800 mg-b-5">Solicitud y registro de factura del pedido de compra al proveedor</h4>
  <p class="mg-b-0"></p>
</div>
...
<div class="br-pagebody">
  <div class="br-section-wrapper">
    ...
    <div class="header">
        ...
        <legend>Listado de Pedidos pendientes de registro de factura de compra
  ...
  <div class="modal-dialog modal-dialog-vertical-center modal-lg" role="document">
    <div class="modal-content bd-0 tx-14">
      ...
      <div class="modal-header pd-y-20 pd-x-25">
        <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Registro de factura de compra</h6>
