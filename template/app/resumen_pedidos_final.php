...
<div class="br-pageheader pd-y-15 pd-l-20">
  <nav class="breadcrumb pd-0 mg-0 tx-12">
    ...
    <span class="breadcrumb-item active">Pedidos cerrados, verificados y pagados al comercial</span>
  </nav>
</div><!-- br-pageheader -->
<div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
  <h4 class="tx-gray-800 mg-b-5">Pedidos cerrados, verificados y pagados al comercial</h4>
  <p class="mg-b-0"></p>
</div>
...
<div class="br-pagebody">
  <div class="br-section-wrapper">
    ...
    <div class="header">
        ...
        <legend>Listado de Pedidos cerrados, verificados y pagados al comercial
            ...
            <tr>
             ...
             <td>
                  <a href="" data-toggle="modal" data-target="#modaldemo1" class="btn btn-simple btn-icon" onclick="editar_lista('<?=$id?>')"><i class="fa fa-truck"></i></a>
                   ...
                   <a href="" data-toggle="modal" data-target="#modaldemo2" class="btn btn-simple btn-icon" onclick="editar_lista('<?=$id?>')"><i class="fa fa-file-pdf-o"></i></a>
  ...
  <div class="modal-dialog modal-dialog-vertical-center modal-lg" role="document">
    <div class="modal-content bd-0 tx-14">
      ...
      <div class="modal-header pd-y-20 pd-x-25">
        <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Pedido cerrado, verificado y pagado al comercial </h6>
            ...
            <div class="content">  
                ...
                <div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-12">
                           <a href="" class="btn btn-info btn-with-icon pull-right" href="" data-toggle="modal" data-target="#modaldemo10" >
                            <div class="ht-40 justify-content-between">
                              <span class="pd-x-15">Comisiones por comercial pagadas</span>
                              <span class="icon wd-40"><i class="fa fa-plus-circle"></i></span>
                           </div>
                         </a>
                            ...
                            <tbody>
                                <tr>
                                  ...
                                  <td>
                                     ...
                                     <a href="" data-toggle="modal" data-target="#modaldemo2" class="btn btn-simple btn-icon" onclick="editar_lista('<?=$id?>')"><i class="fa fa-usd"></i></a>
                                  </td>
                        ...
                        <table id="datatableServicios2" class="table display responsive nowrap" style="width: 100%;">
                          ...
                          <tbody>
                              <tr>
                                ...
                                <td>Dato 3</td>
                                <td>
                                     <a href="" data-toggle="modal" data-target="#modaldemoprestador" class="btn btn-simple btn-icon" onclick="editar_lista('<?=$id?>')"><i class="fa fa-eye"></i></a>
                                     <a href="" data-toggle="modal" data-target="#modaldemo2" class="btn btn-simple btn-icon" onclick="editar_lista('<?=$id?>')"><i class="fa fa-file-pdf-o"></i></a>
                ...
                <h3>Registro de cobro</h3>
                 ...
                 <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label">Adjuntar comprobante</label>
      ...
      <div class="modal-footer">
        ...
        <input id="guardar" type="submit" name="" class="btn btn-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" value="Verificar pedidos"> 
      </div>
        ...
        <div class="form-layout">
          ...
          <div class="content">   
            ...
            <div class="row">
             ...
             <h3>Registro de pago de la factura de compra al proveedor</h3>
            <div class="row">
               <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label">Adjuntrar comprobante</label>
                        <input class="form-control valid" type="file" name="nombre" value="" placeholder="" >
                    </div>
                </div>
...
<div id="modaldemoprestador" class="modal fade">
  
  <div class="modal-dialog modal-dialog-vertical-center modal-md" role="document">
    <div class="modal-content bd-0 tx-14">
      <form id="guardar_usuario" method="post" enctype="multipart/form-data"> 
      <div class="modal-header pd-y-20 pd-x-25">
        <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Factura por su servicio</h6>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body pd-25" id="div_modal_usuario">
        ...
        <div class="form-layout">
          ...
          <div class="content"> 
            ...
            <h3>Registro de factura de prestador de servicios</h3>   
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label">Número de factura de venta asociado</label>
             ...
             <h3>Registro de pago de la factura al proveedor de servicios</h3>
            <div class="row">
               <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label">Adjuntrar comprobante</label>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-secondary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" data-dismiss="modal">Cerrar</button>
        <input id="guardar" type="submit" name="" class="btn btn-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" value="Finalizar pago"> 
      </div>
          ...
          <div class="content">   
            ...
            <div class="row">
               ...
               <table id="datatable" class="table display responsive nowrap" style="width: 100%;">
                  <thead>
                    <tr>
                      <th class="wd-10p">Nombre del comercial</th>
                      <th class="wd-10p">Fecha de carga</th>
                      <th class="wd-10p">Proveedor</th>
                      <th class="wd-10p">Kg netos reales</th>
                      <th class="wd-10p">Comision (€/Kg)</th>

                      <th class="wd-10p">Comisión total</th>
