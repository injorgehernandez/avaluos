...
<div class="br-pageheader pd-y-15 pd-l-20">
  <nav class="breadcrumb pd-0 mg-0 tx-12">
    ...
    <span class="breadcrumb-item active">Pedidos pendientes cerrados y verificados</span>
  </nav>
</div><!-- br-pageheader -->
<div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
  <h4 class="tx-gray-800 mg-b-5">Pedidos pendientes cerrados y verificados</h4>
  <p class="mg-b-0"></p>
</div>
...
<div class="br-pagebody">
  <div class="br-section-wrapper">
    ...
    <div class="header">
        ...
        <legend>Listado de Pedidos pendientes cerrados y verificados
  ...
  <div class="modal-dialog modal-dialog-vertical-center modal-lg" role="document">
    <div class="modal-content bd-0 tx-14">
      ...
      <div class="modal-header pd-y-20 pd-x-25">
        <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Pedido cerrado y verificado </h6>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-12">
                           <a href="" class="btn btn-info btn-with-icon pull-right" href="" data-toggle="modal" data-target="#modaldemo10" >
                            <div class="ht-40 justify-content-between">
                              <span class="pd-x-15">Pagar comisiones por comercial</span>
                              <span class="icon wd-40"><i class="fa fa-plus-circle"></i></span>
                           </div>
                         </a>
