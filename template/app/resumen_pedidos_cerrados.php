...
<div class="br-pageheader pd-y-15 pd-l-20">
  <nav class="breadcrumb pd-0 mg-0 tx-12">
    ...
    <span class="breadcrumb-item active">Pedidos pendientes verificar</span>
  </nav>
</div><!-- br-pageheader -->
<div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
  <h4 class="tx-gray-800 mg-b-5">Cierre del expediente y cálculo del beneficio</h4>
  <p class="mg-b-0"></p>
</div>
...
<div class="br-pagebody">
  <div class="br-section-wrapper">
    ...
    <div class="header">
        ...
        <legend>Listado de Pedidos pendientes de verificar
  ...
  <div class="modal-dialog modal-dialog-vertical-center modal-lg" role="document">
    <div class="modal-content bd-0 tx-14">
      ...
      <div class="modal-header pd-y-20 pd-x-25">
        <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Pedido pendiente de pago al proveedor de servicios </h6>
